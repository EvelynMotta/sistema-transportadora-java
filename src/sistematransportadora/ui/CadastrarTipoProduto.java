 ...
 * @author pedro
 */
public class CadastrarTipoProduto extends javax.swing.JInternalFrame {
    ...
    private void carregarTabela() {
        var tiposProdutos = produtoRepositorio.buscarTipos();
        ...
        produtoTabela.setModel(dataModel);
        
        // Ajuste de tamanho das colunas
        var colunaId = produtoTabela.getColumn("Id");
        colunaId.setMaxWidth(50);
        colunaId.setMinWidth(40);
        
        var colunaPadrao = produtoTabela.getColumn("Padrão");
        colunaPadrao.setMaxWidth(70);
        colunaPadrao.setMinWidth(55);
    }
    
    private void acrescentarNaTabela(ProdutoTipo tipoProduto) {
    ...
    private void initComponents() {
        ...
        cadastroDialogo.setMinimumSize(new java.awt.Dimension(200, 165));
        cadastroDialogo.setModal(true);
        cadastroDialogo.setPreferredSize(new java.awt.Dimension(200, 165));
        cadastroDialogo.setSize(new java.awt.Dimension(200, 165));
        ...
        jLabel1.setText("Nome do tipo de produto");
        ...
        setTitle("Cadastrar Tipo de Produto");
        ...
        produtoTabela.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void btnCadastrarDialogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarDialogoActionPerformed
        try {
            ...
            var idTipo = produtoServico.buscarIdValidaParaTipo();

            ProdutoTipo tipo = new ProdutoTipo(idTipo, nomeTipo, false);
            produtoServico.cadastrarTipo(tipo);
            acrescentarNaTabela(tipo);
    ...
    private void btnApagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApagarActionPerformed
        try {
            var index = produtoTabela.getSelectedRow();
            if (index == -1) {
                throw new Exception("Nenhum tipo de produto foi selecionado!");
            }
            ...
            if (dataModel.getValueAt(index, 2) == "Não") {
                var respostaDialog = JOptionPane.showConfirmDialog(
                    null, 
                    """
                    Ao apagar o tipo de produto, você também apagará todos os produtos
            ...
            produtoServico.apagarTipoPorId(idTipo);
